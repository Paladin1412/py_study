...
# API url
urlpatterns += [ # url(r'^api/v1/messageset', include('core.messageset.urls_api',
...
urlpatterns += [
    ...
    url(r'^interface/', include('core.interface.urls', namespace='interface')),
    url(r'^caseset/', include('core.caseset.urls', namespace='caseset')),
    url(r'^product/', include('core.product.urls', namespace='product')),
    url(r'^result/', include('core.result.urls', namespace='result')),
    url(r'^api/v1', include('core.adminlte.urls_api',namespace='adminlte_api')),
]
